        ...
        <div className="inline-block ">
          <div className="relative">
            ...
            <img
              ...
              alt="icon"
            />
            <div className="h-[1px] w-[120px] absolute  bg-gradient-to-r  left-[209px]  lg:left-[180px]  top-[13px] lg:top-[30px]    from-gray-200 to-teal-70"></div>
          </div>
          ...
          <ul className="my-[45px]">
            <li className="text-[16px] mb-[16px] tracking-[1px]">
              <span className="lg:text-[16px] text-[14px]">Head Office:</span>
              <span className="font-manrope ml-[6px] text-[12px] lg:text-[14px]">
                Plot no. 65, Sector-18 Gurugram, Haryana - 122001, India
              </span>
            </li>
            <li className="text-[16px] mb-[16px] tracking-[1px]">
              <span className="lg:text-[16px] text-[14px]">Sales Office:</span>
              <span className="font-manrope ml-[6px] text-[12px] lg:text-[14px]">
            ...
            <li className="text-[16px]  tracking-[1px]">
              <span className="lg:text-[16px] text-[14px]">Site Address:</span>
              <span className="font-manrope ml-[6px] text-[12px] lg:text-[14px]">
