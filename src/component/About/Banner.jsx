...
export default function Banner() {
  return (
    <section className='bg-[url("/assets/images/about/about_banner_1.jpg")] bg-[bottom] relative h-[66vh] bg-[cover]'>
              <div className="image_overlay absolute top-0  lg:block hidden left-0 h-[100%] w-[100%] bg-[#00000066]"></div>
