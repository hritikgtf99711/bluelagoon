...
const Banner = () => {
    return <section
        ...
        <div className="container relative z-[1] h-[100%]">
            <h1 class="absolute xl:top-[26%] heading-text top-[33%] tracking-[2px] text-[38px] leading-[1.3] uppercase text-center left-[25%] translate-[-50%] font-[600] " data-gsap="fade-up" data-gsap-duration="1" data-gsap-delay="0.6">
