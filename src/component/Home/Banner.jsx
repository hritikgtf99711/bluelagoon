...
const Banner = () => {
    return <section
        ...
        <div className="container lg:block flex flex-col place-items-center  justify-center relative z-[1] h-[100%]">
            <h1 class="lg:absolute xl:top-[200px] heading-text tracking-[2px] text-[38px] leading-[1.3] uppercase text-center left-[25%] lg:translate-[-50%] font-[600] " data-gsap="fade-up" data-gsap-duration="1" data-gsap-delay="0.6">
            ...
            <ul className="lg:absolute lg:inline-block flex lg:w-[auto] w-[100%] place-items-center justify-center gap-[20px] left-0 bottom-[214px]" data-gsap="fade-up" data-gsap-duration="1" data-gsap-delay="0.6">
