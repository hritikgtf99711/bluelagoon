        ...
        return (
            <section className=' relative '>
                ...
                <div className=' mx-[auto]  bg-[linear-gradient(0deg,rgba(0,0,0,0.6)_0%,rgba(0,0,0,0.6)_100%)] py-[120px] h-[100%] w-[100%] text-white relative text-center '>
                        ...
                        <p className='font-manrope my-[25px] capitalize tracking-[1px] mb-[40px] leading-[1.8]'  data-gsap="clip-polygon" data-gsap-duration="1" data-gsap-delay="0.6">Your perfect beachside escape is just a message away <span className='lg:block'></span>
