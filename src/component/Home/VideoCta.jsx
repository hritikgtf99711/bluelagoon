...
<video  src="/assets/video/cta_video.mp4"  className="w-[100%] h-[100%] absolute top-0 object-cover" playsInline loop autoPlay muted>
    <source src="/assets/video/cta_video.mp4"  playsInline loop autoPlay mute   type="video/mp4"/>
...
<div className=' mx-[auto]  bg-[linear-gradient(0deg,rgba(0,0,0,0.6)_0%,rgba(0,0,0,0.6)_100%)] py-[120px] h-[100%] w-[100%] text-white relative text-center '>
    ...
    <a href='javascript:void(0)' onClick={openModal} className='bg-[white] lg:text-[16px] text-[14px] text-[#000] uppercase font-[600] inline-block  font-[500] px-[40px] py-[12px]'  data-gsap="clip-polygon" data-gsap-duration="1" data-gsap-delay="0.6">Download Brochure</a>
        </div>
</div>
</section>
)
