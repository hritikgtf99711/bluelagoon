        ...
        return (
            <section className=' relative '>
                ...
                <div className=' mx-[auto]  bg-[linear-gradient(0deg,rgba(0,0,0,0.6)_0%,rgba(0,0,0,0.6)_100%)] py-[120px] h-[100%] w-[100%] text-white relative text-center '>
                        ...
                        <h2 className='text-[65px] font-[600]'  data-gsap="clip-polygon" data-gsap-duration="1" data-gsap-delay="0.6">Get In Touch</h2>
                        <p className='font-manrope my-[25px] capitalize tracking-[1px]  lg:px-0 px-[30px] mb-[40px] leading-[1.8]'  data-gsap="clip-polygon" data-gsap-duration="1" data-gsap-delay="0.6">Your perfect beachside escape is just a message away <span className='lg:block'></span>
