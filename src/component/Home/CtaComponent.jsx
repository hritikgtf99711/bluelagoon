...
const CtaComponent=()=>{
    return <section className="bg-[url('/assets/images/home/cta_banner.jpg')]  bg-[bottom] relative bg-[cover] lg:h-[100vh] h-[60vh]" >
        ...
        <div className="content text-center">
            ...
            <h3  data-gsap="fade-down" data-gsap-duration="1" data-gsap-delay="0.6" className="lg:bg-gradient-to-t font-[600] text-[20px] lg:text-[32px] uppercase from-[#1A4A5B]  to-[#412C24] text-[#fff] lg:text-transparent lg:bg-clip-text">
                 residential project IN
            </h3>
            <h2 data-gsap="fade-down" data-gsap-duration="1" data-gsap-delay="0.6"  className="lg:bg-gradient-to-t from-[#412C24] uppercase lg:!text-[60px] !text-[26px] font-[600] to-[#1A4A5B] text-[#fff] lg:text-transparent lg:bg-clip-text">Maldives</h2>
        </div>
        </div>
